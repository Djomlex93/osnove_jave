...
//        dole navedenoj konverziji. Metoda od parametara prima vrednost u eurima kao i
//        valutu u kojoj je potrebno izvrsiti konverziju (RSD/USD/RUB) a vraca konvertovanu
...
//        1 EUR = 62.98 RUB
        ...
        System.out.println(e+" "+" EUR = " + konverzija(e, valuta) + " " + valuta);
